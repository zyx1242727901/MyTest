...
//            orderProducer.setNamesrvAddr("39.105.95.181:9876");
            orderProducer.setNamesrvAddr("10.10.1.239:9876");
            orderProducer.start();
            //有序消息=============================
//            for (int i = 1; i <= 5; i++) {
//                int orderId = i;
...
//            }
            ...
            //延时消息=============================
            TestBean testBean = new TestBean("张三", 11);
            Message message = new Message("topicDelay", "tagDelay", "keyDelay", SerializationUtils.serialize(testBean));
